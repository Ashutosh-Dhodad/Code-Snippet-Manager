...
code_editor = CodeEditor(middleFrame, width=60, height=20, language="java", highlighter="dracula",
...
runButton = Button(buttonFrame, text="Run", command=run, bg=select_bg_color, fg="white")
...
submitButton = Button(buttonFrame, text="Submit", command=submit, bg=select_bg_color, fg="white")
